...
const genreList = {};
genreList.genres = [];
fetch('https://api.themoviedb.org/3/genre/movie/list?api_key=460ad8448635789cb7af9acdaa3d45f2')
...
genreList.listGenres = () => {
    ...
    submitButton.addEventListener('submit', function (e) {
        ...
        const url = new URL('https://api.themoviedb.org/3/discover/movie?api_key=460ad8448635789cb7af9acdaa3d45f2');
